# encoding: utf-8
# module MySQLdb._mysql
# from C:\Users\dell\AppData\Local\Programs\Python\Python37\lib\site-packages\MySQLdb\_mysql.cp37-win_amd64.pyd
# by generator 1.145
"""
...
# imports
import MySQLdb._exceptions as __MySQLdb__exceptions
...
class connection(object):
    ...
    def _get_native_connection(self, *args, **kwargs): # real signature unknown
        """
...
class Error(__MySQLdb__exceptions.MySQLError):
    """
...
class DatabaseError(__MySQLdb__exceptions.Error):
    """
...
class DataError(__MySQLdb__exceptions.DatabaseError):
    """
...
class IntegrityError(__MySQLdb__exceptions.DatabaseError):
    """
...
class InterfaceError(__MySQLdb__exceptions.Error):
    """
...
class InternalError(__MySQLdb__exceptions.DatabaseError):
    """
...
class NotSupportedError(__MySQLdb__exceptions.DatabaseError):
    """
...
class OperationalError(__MySQLdb__exceptions.DatabaseError):
    """
...
class ProgrammingError(__MySQLdb__exceptions.DatabaseError):
    """
...
class Warning(Warning, __MySQLdb__exceptions.MySQLError):
    """
